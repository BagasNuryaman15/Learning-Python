print("\n")
print(" Style Guide Prinsip Penamaan pada Python ".centar(150, "=") + "\n")
'''
...
Namun, perlu diperhatikan juga bahwa Anda dapat memilih mempertahankan styling yang sudah digunakan sebelumnya untuk menjaga konsistensi internal tim atau perusahaan. Ini karena konsistensi internal lebih diutamakan.
    ...
    3.  Hal-hal yang Harus Dipertimbangkan dalam Penamaan
        ...
        9. Nama Fungsi, Parameter, dan Variabel
        ...
        11. Nama Method dan Variabel Instance
        ...
        13. Selalu Persiapkan untuk Inheritance
